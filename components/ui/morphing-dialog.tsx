  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        'before:absolute before:inset-0 before:bg-gradient-to-b before:from-primary/5 before:via-transparent before:to-transparent before:opacity-0 before:transition-opacity before:duration-500 hover:before:opacity-100',
        className
      )}
      style={style}
      role='dialog'
...
function MorphingDialogClose({
  ...
  return (
    <motion.button
      ...
      className={cn(
        'absolute right-6 top-6 p-2 rounded-full hover:bg-primary/10 transition-colors duration-300',
        className
      )}
      initial='initial'
      animate='animate'
