...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    return (
        <div
            className="w-full bg-background/50 backdrop-blur-sm font-sans md:px-10"
            ref={containerRef}
        >
            <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
                ...
                >
                    A journey through my professional experiences and achievements in AI and software development.
                </motion.p>
            </div>
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            <motion.div
                                ...
                                transition={{ duration: 0.5 }}
                                className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background/50 backdrop-blur-sm flex items-center justify-center"
                            >
                            ...
                            <motion.h3
                                ...
                                transition={{ duration: 0.5, delay: 0.2 }}
                                className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-gradient"
                            >
                                {item.title}
                            </motion.h3>
                        </div>
                        ...
                        <div className="relative pl-20 pr-4 md:pl-4 w-full">
                            <motion.h3
                                ...
                                whileInView={{ x: 0, opacity: 1 }}
                                transition={{ duration: 0.5 }}
                                className="md:hidden block text-2xl mb-4 text-left font-bold text-gradient"
                            >
                                {item.title}
                            </motion.h3>
                            {item.content}
